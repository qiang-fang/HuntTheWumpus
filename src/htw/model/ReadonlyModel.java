...
public interface ReadonlyModel {
   ...
   */
  List<TypeOfDirection> getPossibleMove(int currentId);
   ...
   */
  TypeOfLocation getCurrentLocationType();
   ...
   */
  String smell(List<TypeOfDirection> listOfDirection);
   ...
   */
  Map<TypeOfDifficulty, Boolean> getCurrentDifficulty();
   ...
   * @return difficulty including if there is a pit, bat, wumpus
   */
  Map<TypeOfDifficulty, Boolean> getCurrentDifficulty(int id);
