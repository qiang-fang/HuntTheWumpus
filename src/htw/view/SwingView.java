...
public class SwingView extends JFrame implements View {
  ...
  public SwingView(String windowTitle) {
    ...
    menuBar.add(restart);
    this.stopGame = new JMenuItem("Stop game", KeyEvent.VK_P);
    restart.add(stopGame);
    this.restartSame = new JMenuItem("Restart same game", KeyEvent.VK_S);
    restart.add(restartSame);
    this.restartNew = new JMenuItem("Start new game", KeyEvent.VK_N);
    restart.add(restartNew);
    JMenu help = new JMenu("Help");
    help.setMnemonic(KeyEvent.VK_H);
    menuBar.add(help);
    this.about = new JMenuItem("About", KeyEvent.VK_B);
    help.add(about);
  ...
  public TypeOfDirection showShootDirectionDialog(TypeOfDirection[] options) {
    ...
    return  (TypeOfDirection) JOptionPane.showInputDialog(null,
  ...
  private void refreshUnexploredBackground(int currentId) {
    List<TypeOfDirection> directions = model.getPossibleMove(currentId);
    ...
    try {
      ...
      Map<TypeOfDifficulty, Boolean> difficulty = model.getCurrentDifficulty(currentId);
  ...
  public void setFeatures(Controller f) {
    ...
    about.addActionListener(l -> f.showAbout());
